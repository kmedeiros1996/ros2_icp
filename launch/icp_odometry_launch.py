...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('ros2_icp')
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(bringup_dir, 'params', 'icp_params.yaml'),
